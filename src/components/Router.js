  ...
  render() {
    return (
      <Switch>
        ...
        {/* <Route exact path="/bebidas/:id-da-receita/in-progress" component={Drinks} /> */}
        ...
        {/* <Route exact path="/explorar/bebidas/ingredientes" component={IngredientsDrinks} /> */}
        {/* <Route exact path="/explorar/comidas/area" component={RegionFoods} /> */}
