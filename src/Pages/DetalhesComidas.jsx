...
const DetalhesComida = () => {
  ...
  const getIngredientsOrMeasure = (param) => {
    ...
    const dataKeys = Object.keys(dataObject).filter(
      (key) => key.includes(param) && dataObject[key] !== '' && dataObject[key] !== ' ',
    );
        ...
        <div className="container-main">
          ...
          <div className="container-initial">
            ...
            <div className="title-e-icons">
              ...
              <span data-testid="recipe-title">{stateLocal.food.meals[0].strMeal}</span>
              <div>
            ...
            <div className="instructions">
              ...
              <div data-testid="instructions">{stateLocal.food.meals[0].strInstructions}</div>
            </div>
            <div className="video">
              <span>Video</span>
              <a data-testid="video" href={stateLocal.food.meals[0].strYoutube}>
                <img
                  src={stateLocal.food.meals[0].strMealThumb}
                  alt={stateLocal.food.meals[0].strMeal}
                />
            ...
            <div className="main-recomendations">
              {stateSugestions &&
                stateSugestions.drinks.map((drink, index) => {
                  if (index <= number) {
                    return (
                      <div
